...
class SklearnModelGenerator(BaseModelGenerator):
    ...
    def build_model(self) -> Any:
        ...
        if pipeline_steps and main_estimator is not None:
            ...
            logger.warning(
                "No valid sklearn components found, creating default LinearRegression"
            )
    ...
    def _create_component(self, layer_config: LayerConfig) -> Any:
        ...
        # Ensemble methods
            ...
            return self._sklearn_modules["ensemble"].GradientBoostingClassifier(
                **kwargs
            )
                ...
                if params:
                    ...
                    if len(params) > 10:
                        summary_lines.append(
                            f"  ... and {len(params) - 10} more parameters"
                        )
